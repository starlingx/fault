...
class FmShell(object):
    ...
    def get_base_parser(self):
        ...
        parser.add_argument('--version',
                            action='version',
                            version=fmclient.__version__)

        parser.add_argument('--debug',
                            default=bool(utils.env('FMCLIENT_DEBUG')),
                            action='store_true',
                            help='Defaults to env[FMCLIENT_DEBUG]')
        ...
        parser.add_argument('--fm-url',
                            default=utils.env('FM_URL'),
                            help='Defaults to env[FM_URL]')

        parser.add_argument('--fm_url',
                            help=argparse.SUPPRESS)

        parser.add_argument('--fm-api-version',
                            default=utils.env('FM_API_VERSION', default='1'),
                            help='Defaults to env[FM_API_VERSION] '
                            'or 1')

        parser.add_argument('--fm_api_version',
                            help=argparse.SUPPRESS)
    ...
    def get_subcommand_parser(self, version):
        ...
        submodule = importutils.import_versioned_module('fmclient',
                                                        version, 'shell')
