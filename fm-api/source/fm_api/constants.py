...
FM_ENTITY_TYPE_CONTROLLER_FS = 'controller_fs'
...
FM_ALARM_ID_CONTROLLER_FS_FAILED = ALARM_GROUP_STORAGE + ".105"
...
FM_ALARM_ID_USM_CLEANUP_DEPLOYMEMT_DATA = ALARM_GROUP_SW_MGMT + ".022"
